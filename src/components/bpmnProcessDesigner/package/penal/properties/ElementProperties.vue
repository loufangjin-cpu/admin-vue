<template>
	<div class="panel-tab__content">
		<el-table stripe :data="elementPropertyList" max-height="240" border fit>
			...
			<el-table-column label="操作" width="110px">
				<template #default="scope">
					...
					<el-button link size="small" style="color: #ff4d4f" @click="removeAttributes(scope.row, scope.$index)"> 移除 </el-button>
				</template>
			</el-table-column>
		</el-table>
