<template>
	<el-form
		...
		:style="{
			...
			'grid-template-columns': `repeat(${colLength}, minmax(220px, ${100 / colLength}%))`,
		}"
		@submit.prevent
	>
		<el-form-item
		...
		>
			<el-button class="btn_check" @click="checkHandle" v-bind="queryAttrs" :loading="loading">搜索</el-button>
...
defineOptions({ name: 'QueryCondition' });
