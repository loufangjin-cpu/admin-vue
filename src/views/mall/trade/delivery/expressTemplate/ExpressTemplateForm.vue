		...
		<el-form ref="formRef" :model="formData" :rules="formRules" label-width="80px" v-loading="formLoading">
			...
			<el-form-item label="计费方式" prop="chargeMode">
				<el-radio-group v-model="formData.chargeMode" @change="changeChargeMode">
					<el-radio v-for="dict in getIntDictOptions(DICT_TYPE.EXPRESS_CHARGE_MODE)" :key="dict.value" :label="dict.value">
						{{ dict.label }}
					</el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item label="运费" prop="templateCharge">
				<el-table stripe border style="width: 100%" :data="formData.templateCharge">
			...
			<el-form-item label="包邮区域" prop="templateFree">
				<el-table stripe border style="width: 100%" :data="formData.templateFree">
