<template>
	...
	<ContentWrap>
		<el-form ref="queryFormRef" :inline="true" :model="queryParams" class="-mb-15px" label-width="82px">
			...
			<el-form-item label="优惠券类型" prop="discountType">
				<el-select v-model="queryParams.discountType" class="!w-240px" placeholder="请选择优惠券类型" clearable>
			...
			<el-form-item label="优惠券状态" prop="status">
				<el-select v-model="queryParams.status" class="!w-240px" placeholder="请选择优惠券状态" clearable>
			...
			<el-form-item>
				...
				<el-button plain type="success" @click="$router.push('/promotion/coupon')" v-hasPermi="['promotion:coupon:query']">
	...
	<ContentWrap>
		<el-table stripe v-loading="loading" :data="list">
			...
			<el-table-column label="有效期限" align="center" prop="validityType" width="190" :formatter="validityTypeFormat" />
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
				<template #default="scope">
					<el-button v-hasPermi="['promotion:coupon-template:update']" link type="primary" @click="openForm('update', scope.row.id)">
						修改
					</el-button>
...
import { CommonStatusEnum, CouponTemplateValidityTypeEnum, PromotionDiscountTypeEnum } from '@/utils/constants';
