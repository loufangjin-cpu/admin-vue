	...
	<ContentWrap>
		<el-tabs v-model="type" @tab-change="onTabChange">
			...
			<el-tab-pane :name="UploadType.Image">
				...
				<UploadFile v-hasPermi="['mp:material:upload-permanent']" :type="UploadType.Image" @uploaded="getList">
			...
			<el-tab-pane :name="UploadType.Voice">
				...
				<UploadFile v-hasPermi="['mp:material:upload-permanent']" :type="UploadType.Voice" @uploaded="getList">
