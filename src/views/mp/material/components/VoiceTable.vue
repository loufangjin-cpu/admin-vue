<template>
	<el-table stripe :data="props.list" stripe border v-loading="props.loading" style="margin-top: 10px">
		...
		<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
			<template #default="scope">
				...
				<el-button type="primary" link @click="emit('delete', scope.row.id)" v-hasPermi="['mp:material:delete']">
