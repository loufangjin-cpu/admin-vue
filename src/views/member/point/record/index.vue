<template>
	<ContentWrap>
		...
		<el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
			<el-form-item label="业务编码" prop="bizId">
				<el-input v-model="queryParams.bizId" placeholder="请输入业务编码" clearable @keyup.enter="handleQuery" class="!w-240px" />
			</el-form-item>
			<el-form-item label="业务类型" prop="bizType">
				<el-select v-model="queryParams.bizType" placeholder="请选择业务类型" clearable class="!w-240px">
					<el-option v-for="dict in getStrDictOptions(DICT_TYPE.MEMBER_POINT_BIZ_TYPE)" :key="dict.value" :label="dict.label" :value="dict.value" />
				</el-select>
			</el-form-item>
			...
			<el-form-item label="积分状态" prop="status">
				<el-select v-model="queryParams.status" placeholder="请选择状态" clearable class="!w-240px">
					<el-option v-for="dict in getIntDictOptions(DICT_TYPE.MEMBER_POINT_STATUS)" :key="dict.value" :label="dict.label" :value="dict.value" />
				</el-select>
			</el-form-item>
	...
	<ContentWrap>
		<el-table stripe v-loading="loading" :data="list">
			...
			<el-table-column label="获得时间" align="center" prop="createDate" :formatter="dateFormatter" />
			...
			<el-table-column label="冻结时间" align="center" prop="freezingTime" :formatter="dateFormatter" />
			<el-table-column label="解冻时间" align="center" prop="thawingTime" :formatter="dateFormatter" />
		</el-table>
		<!-- 分页 -->
