	...
	<ContentWrap>
		...
		<el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
			...
			<el-form-item>
				...
				<el-button type="primary" plain v-hasPermi="['bpm:process-instance:query']" @click="handleCreate">
		...
		<el-table stripe v-loading="loading" :data="list">
			...
			<el-table-column label="操作" align="center">
				<template #default="scope">
					...
					<el-button link type="primary" v-if="scope.row.result === 1" v-hasPermi="['bpm:process-instance:query']" @click="handleCancel(scope.row)">
						取消
					</el-button>
				</template>
			</el-table-column>
