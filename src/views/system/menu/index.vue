<template>
	...
	<!-- 列表 -->
	<ContentWrap>
		<el-table stripe v-if="refreshTable" v-loading="loading" :data="list" :default-expand-all="isExpandAll" row-key="id">
			...
			<el-table-column align="center" label="操作">
				<template #default="scope">
					...
					<el-button v-hasPermi="['system:menu:create']" link type="primary" @click="openForm('create', undefined, scope.row.id)"> 新增 </el-button>
