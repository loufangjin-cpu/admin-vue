<template>
	<el-table stripe ref="dragTable" :data="formData" :max-height="tableHeight" row-key="columnId">
		...
		<el-table-column label="列表" min-width="4%">
			<template #default="scope">
				<el-checkbox v-model="scope.row.listOperationResult" false-label="false" true-label="true" />
			</template>
		</el-table-column>
